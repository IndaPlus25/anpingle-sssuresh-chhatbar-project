...
def draw_portfolio_screen(game_surface, title_font, body_font, small_font, player, stocks, scroll_y, active_tab="Holdings"):
    ...
    import pygame
    from .constants import GOLD, WHITE, GRAY, GREEN, RED, BLUE
    
    # --- FIX: Widened to 880px to fit 4 Stats Columns cleanly ---
    win_w, win_h = 880, 550
    win_x, win_y = (game_surface.get_width() - win_w) // 2, (game_surface.get_height() - win_h) // 2
    box = pygame.Rect(win_x, win_y, win_w, win_h)
    ...
    # 1. Calculate Active Holdings (Unrealized P&L)
    ...
    # 2. Calculate Sold History (Realized P&L)
    ...
    # Column 2: Unrealized P&L (Active Stocks)
    ...
    # Column 3: Realized P&L (Sold Stocks)
