...
def draw_market_overlay(game_surface, body_font, hud_font, small_font, stocks, selected_stock_idx=0):
    ...
    if stock.current_pattern_name:
        ...
        if pinfo:
            ...
            bar_x, bar_w, bar_h, bar_y_pos = left_x + 420, 200, 14, pattern_y + 6
...
def draw_news_screen(game_surface, title_font, body_font, small_font,
                     news_items, scroll_offset=0, game_clock=None):
